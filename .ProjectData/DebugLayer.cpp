	...
	if (ImGui::BeginMenuBar())
	{
		if (ImGui::BeginMenu("Editor"))
		{
			...
			if (ImGui::MenuItem("Refresh Assets", "", false)) {
				GEngine::FileSystem::PakDirectory(GEngine::FileSystem::GetParentExecuteableDir(3) + "Sandbox/Content",
				...
				GEngine::FileSystem::Copy(GEngine::FileSystem::FilePath("Data/Content.pak"),
					GEngine::FileSystem::GetParentExecuteableDir(3) + "Sandbox/Data/Content.pak", false);
