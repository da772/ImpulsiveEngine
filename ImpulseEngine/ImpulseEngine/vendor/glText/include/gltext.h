...
GLT_API void gltDrawText3D_Billoard(GLTtext* text, GLfloat x, GLfloat y, GLfloat z, GLfloat scale, GLfloat view[16], GLfloat projection[16]);
...
GLT_API void gltDrawText3D_MVP(GLTtext* text, GLfloat model[16], GLfloat view[16], GLfloat projection[16])
{
	if (!text)
		return;
