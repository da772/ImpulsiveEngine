...
#define DUKGLUE_SIMPLE_VALUE_TYPE(TYPE, DUK_IS_FUNC, DUK_GET_FUNC, DUK_PUSH_FUNC, PUSH_VALUE) \
		...
		DUKGLUE_SIMPLE_VALUE_TYPE(unsigned long long, duk_is_number, duk_get_number, duk_push_number, value) // have to cast to double
		...
		DUKGLUE_SIMPLE_VALUE_TYPE(long, duk_is_number, duk_get_number, duk_push_number, value) // have to cast to double
		DUKGLUE_SIMPLE_VALUE_TYPE(long long, duk_is_number, duk_get_number, duk_push_number, value) // have to cast to double
