#include "gepch.h"
#include "Public/Platform/Graphics/OpenGL/OpenGL_Texture.h"
...
namespace GEngine {
	...
	void OpenGL_Texture2D::SetData(void* data, uint32_t size, u32 flags, int width, int height)
	{
		...
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, (m_flags & TEXTUREFLAGS_DisableMipMap) ? GL_NEAREST : GL_NEAREST_MIPMAP_NEAREST);
