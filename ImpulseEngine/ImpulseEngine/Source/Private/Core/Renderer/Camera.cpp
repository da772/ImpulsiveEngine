...
namespace GEngine {
	...
	{
		glm::mat4 transform = glm::translate(glm::mat4(1.f), glm::vec3(m_Position.x, m_Position.y, m_Position.z)) * glm::rotate(glm::mat4(1.f), glm::radians(m_flRotation), glm::vec3(0, 0, 1));
	...
	{
		glm::mat4 transform = glm::translate(glm::mat4(1.f), glm::vec3(m_Position.x ,m_Position.y, m_Position.z)) * glm::rotate(glm::mat4(1.f), glm::radians(m_Rotation.x), glm::vec3(1, 0, 0)) *
