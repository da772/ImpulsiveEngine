...
namespace GEngine {
	...
	public:
		...
		inline static void DrawIndexedInstanced(const Ref<VertexArray>& vertexArray, u32 size, int amount) { s_RendererAPI->DrawIndexedInstanced(vertexArray, size, amount); }
