...
class Vector2 {
    public:
        ...
        inline T length() { return sqrt<T>(x*x+y*y); }
        inline T size() { return length(); }
        inline T magnitude() { return length(); }
...
class Vector3 {
    public:
        ...
        inline T length() { return sqrt<T>(x*x+y*y+z*z); }
        inline T size() { return length(); }
        inline T magnitude() { return length(); }
        inline Vector3<T> normalize() { return (*this)/length();}
...
class Vector4 {
    public:
        ...
        inline T length() { return sqrt<T>(x*x+y*y+z*z+w*w); }
        inline T size() { return length(); }
        inline T magnitude() { return length(); }
        inline Vector4<T> normalize() { return (*this)/length();}
