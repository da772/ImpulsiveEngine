...
namespace Editor {
	...
	bool ToolbarModule::ControlButtons(const std::string& s)
	{
		...
		bool isHovered = ImGui::IsWindowHovered() && ImGui::IsMouseHoveringRect(pos, { pos.x + imageButtonSize, pos.y + imageButtonSize });
		ImGui::GetWindowDrawList()->AddRectFilled(pos, { pos.x + imageButtonSize, pos.y + imageButtonSize }, ImGui::GetColorU32(ImGui::GetStyleColorVec4(!isHovered ? ImGuiCol_Button : ImGuiCol_ButtonHovered)), 2.f);
