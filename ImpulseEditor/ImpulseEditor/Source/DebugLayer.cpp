...
static void RefreshAssets() {
	GEngine::FileSystem::PakDirectory(GEngine::FileSystem::GetParentExecuteableDir(3) + "ImpulseEditor/Content",
	...
	GEngine::FileSystem::Copy(GEngine::FileSystem::FilePath("Data/Content.pak"),
		GEngine::FileSystem::GetParentExecuteableDir(3) + "ImpulseEditor/Data/Content.pak", false);
