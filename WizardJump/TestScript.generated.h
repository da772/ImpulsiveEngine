...
class TestScript_Generated : public refl::class_generation {
	...
	inline static void Load(::refl::store::storage* storage) {
		...
		{"OnUpdate",{"OnUpdate","void",static_cast<refl::store::uproperty_type>(3),{{static_cast<::refl::store::uproperty_type>(1),"Timestep"} },[](void* ptr, std::vector<void*> args) { (*((TestScript*)ptr).*(&TestScript::OnUpdate))(); return nullptr; } }}}});
	}
