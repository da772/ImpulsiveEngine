...
void BackgroundEntity::OnBegin()
{
	...
	m_backgroundSprite->CreateQuad({ 0,0,-2 }, 0, { 1000,1000,1 }, { 181.f/255.f,244.f/255.f,249.f/255.f, 1 },
		nullptr, {1, 1});
	m_backgroundSprite->CreateQuad({ 0,60,-1 }, 0, { 33.75f, 120, 1 }, { 1,1,1,1 }, GEngine::Texture2D::Create("Content/Textures/skyGradient.png"), { 1,1 });
}
