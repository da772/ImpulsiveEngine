...
class Logger_Generated : public refl::class_generation {
	...
	inline static void Load(::refl::store::storage* storage) {
		...
		{"SetupLogs",{"SetupLogs","std::shared_ptr<spdlog::logger>",static_cast<refl::store::uproperty_type>(1),{{static_cast<::refl::store::uproperty_type>(1),"std::shared_ptr<spdlog::logger>"} },[](void* ptr, std::vector<void*> args) {std::shared_ptr<spdlog::logger> v = (*((Logger*)ptr).*(&Logger::SetupLogs))(*(std::shared_ptr<spdlog::logger>*)args[0]); std::shared_ptr<spdlog::logger>* _ptr = new std::shared_ptr<spdlog::logger>(v); return (void*)_ptr; } }},
		{"DestroyLogs",{"DestroyLogs","void",static_cast<refl::store::uproperty_type>(3),{},[](void* ptr, std::vector<void*> args) { (*((Logger*)ptr).*(&Logger::DestroyLogs))(); return nullptr; } }}}});
	}
